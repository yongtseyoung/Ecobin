...
$total_weight_kg = $waste_stats['total_weight'] ?? 0;
    ...
    <div class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo number_format($waste_stats['total_bins_collected']); ?></div>
                <div class="stat-label">Bins Collected</div>
                <div class="stat-subtext"><?php echo $waste_stats['total_collections']; ?> collection tasks</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">
                    ...
                    $avg_per_day = $waste_stats['total_bins_collected'] / $days_in_period;
                    echo number_format($avg_per_day, 1);
                    ?>
                </div>
                <div class="stat-label">Avg Bins/Day</div>
                <div class="stat-subtext">Collection rate</div>
            </div>
        </div>
        ...
        <div class="impact-card">
            ...
            <div class="impact-grid">
                <div class="impact-item">
                    ...
                    <div class="impact-value"><?php echo number_format($co2_saved, 1); ?> kg</div>
                    <div class="impact-label">CO₂ Emissions Saved</div>
                </div>
                <div class="impact-item">
                    <div class="impact-icon">🌳</div>
                    <div class="impact-value"><?php echo number_format($trees_saved, 0); ?></div>
                    <div class="impact-label">Trees Equivalent</div>
                </div>
                <div class="impact-item">
                    <div class="impact-icon">⚡</div>
                    <div class="impact-value"><?php echo number_format($energy_saved, 1); ?> kWh</div>
