        ...
        <div class="form-container">
            <div class="alert alert-info">
                ...
                <ul style="margin: 10px 0 0 20px; line-height: 1.8;">
                    <li>Create bin with a unique Bin Code</li>
                    <li>Update ESP32 code with the same Bin Code</li>
                    <li>ESP32 will automatically register and link to this bin</li>
                </ul>
            </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   required>
                            <small>Unique identifier - must match the bin_code in your ESP32 code</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <small>Select the area where this bin is located</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   min="0.01" 
                                   required>
                            <small>Maximum capacity in liters</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   min="0.01" 
                                   required>
                            <small>Maximum weight capacity in kg</small>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <small>Specific location description to help identify the bin</small>
                        </div>
                    </div>
                </div>
