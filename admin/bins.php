...
$offline_bins = count(array_filter($bins, fn($b) => $b['device_status'] === 'offline' || !$b['device_status']));
...
<head>
    ...
    <style>
        * {
        ...
        .refresh-notice {
            background: linear-gradient(135deg, #899b74ff 100%);
            color: white;
            padding: 15px 25px;
            border-radius: 15px;
            margin-bottom: 20px;
        ...
        .refresh-notice span:first-child {
            font-size: 24px;
        }

        .refresh-notice span:nth-child(2) {
            flex: 1;
            font-size: 14px;
            font-weight: 500;
        }
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="refresh-notice">
            <span>🔄</span>
            <div style="flex: 1;">
                <div style="font-weight: 600; margin-bottom: 3px;">Live IoT Monitoring Active</div>
                <div class="live-indicator">
                    <span class="live-dot"></span>
                    <span>Auto-refresh every 30 seconds • Last update: <span id="lastRefresh"><?php echo date('g:i:s A'); ?></span></span>
                </div>
            </div>
    ...
    <script>
        ...
        setInterval(function() {
            document.getElementById('lastRefresh').textContent = new Date().toLocaleTimeString('en-US', {
                hour: 'numeric',
                minute: '2-digit',
                second: '2-digit',
                hour12: true
