                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions-btns">
                                        <a href="task_view.php?id=<?php echo $task['task_id']; ?>" class="btn btn-secondary btn-icon">
                                            👁️ View
                                        </a>
                                        <?php if ($task['status'] !== 'completed' && $task['status'] !== 'cancelled'): ?>
                                            <a href="task_edit.php?id=<?php echo $task['task_id']; ?>" class="btn btn-primary btn-icon">
                                                ✏️ Edit
                                            </a>
                                        <?php endif; ?>
                                    </div>
