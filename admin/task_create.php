    ...
    <main class="main-content">
        ...
        <div class="form-container">
            <div class="info-box">
                ...
                <p>Create a task and assign it to an employee. For automatic task creation based on IoT sensors, bins will auto-generate collection tasks when they reach 80% capacity.</p>
            </div>
            ...
            <form method="POST" action="task_actions.php">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <small>Optional: Leave empty if task is not area-specific</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small>Select if task is related to a specific bin</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small>Optional: Leave empty for flexible timing</small>
                    </div>
