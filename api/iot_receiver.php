...
try {
    ...
    // Step 2: Register or update IoT device
    ...
    // Step 6: Auto-create task if bin >= 80% full
    $task_created = false;
    if ($fill_level >= 80) {
